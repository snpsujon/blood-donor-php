      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
        <ul class="navbar-nav w-100">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="Registerform.php">Be a Volunteer</a>
          </li>
          <li class="nav-item @@causes__active">
            <a class="nav-link" href="blodon.php">Blood donation</a>
          </li>
            ...
            <div class="top-map">
                <div class="row map-content-9">
                    <div class="col-lg-8">
                        ...
                        <form action="Register.php" method="POST" class="text-right">
                            <div class="form-grid">
