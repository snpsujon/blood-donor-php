<!--
This is the homepage of alhamdulillah foundation
-->
<?php
session_start();
?>
  ...
  <div class="container">
    <nav class="navbar navbar-expand-lg stroke">
      <h1><a class="navbar-brand mr-lg-5" href="index.php">
        <img src="assets/images/aflogo.png" alt="Your logo" title="Your logo" />Alhamdulillah Foundation
        </a></h1>
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
        <ul class="navbar-nav w-100">
          ...
          <?php
            ...
            ?>
            <a class="nav-link" href="logout.php"><?php echo $_SESSION['user']?> Logout</a>
        <?php
            }else {
                ?>
