                    ...
                    <div class="col-lg-8">
                        ...
                        <form action="bloodregister.php" method="POST" class="text-right">
                            <div class="form-grid">
                                ...
                                <input type="text" name="name" id="w3lSender" placeholder="Name" required="">
                                <input type="text" name="fathername" id="w3lSender" placeholder="Father Name" required="">
                                <input type="digits" name="nid" id="w3lPhone" placeholder="NID"
                                    required="">
                                <input type="digits" name="phone" id="w3lPhone" placeholder="Phone number"
                                    required="">
                                <input type="text" name="address" id="w3lSubject" placeholder="Address">

                                <input type="text" name="bloodgroup" id="w3lSubject" placeholder="Blood Group">
