    ...
    <a class="navbar-brand" href="#index.php">
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
        <ul class="navbar-nav w-100">
          ...
          <li class="nav-item @@searchblood__active">
...
if (mysqli_num_rows($result) > 0) {
	...
	echo "<tr><th>Name</th><th>Father Name</th><th>NID</th><th>Phone</th><th>Address</th><th>Blood Group</th></tr>";
    while($row = mysqli_fetch_assoc($result)) {
	echo "<tr>";
        echo "<td>" . $row["name"]. "</td><td>" . $row["fathername"]. "</td><td>" .$row["nid"]."</td><td>" . $row["phone"]. "</td><td>" . $row["address"]. "</td><td>" . $row["bloodgroup"]. "</td>";
