            ...
            <div class="top-map">
                <div class="row map-content-9">
                    <div class="col-lg-8">
                        ...
                        <p class="mb-4 mt-lg-0 mt-2">

                        <form action="loginbe.php" method="POST" class="text-right">
                            <div class="form-grid">
                              
                                
                                 <input type="text" name="username" id="w3lSender" placeholder="User name" required>


                                <input type="password" name="password" id="w3lSender" placeholder="Password" required>
