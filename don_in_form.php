<!--
How the donation came in foundation.This is the page where every information of donation will come.Cashier can input all the information here.
-->
<?php
session_start();
...
<php lang="en">
  <head>
    ...
    <title>Alhamdulillah - Charity</title>
...
<div class="inner-banner">
    <section class="w3l-breadcrumb py-5">
        <div class="container py-lg-5 py-md-3">
            <h2 class="title">Join as blood donor</h2>
        </div>
    </section>
</div>
<!-- banner bottom shape -->
        ...
        <div class="container">
            <div class="top-map">
                <div class="row map-content-9">
                    <div class="col-lg-8">
                        <h3 class="title-big">Please fill out all the information</h3>
                        <p class="mb-4 mt-lg-0 mt-2">Feel free to give the information. Your information will not be published anywhere.</p>
                        <form action="bloodregister.php" method="POST" class="text-right">
                            <div class="form-grid">
                                
                                <input type="text" name="name" id="w3lSender" placeholder="Date" required="">
                                <input type="text" name="fathername" id="w3lSender" placeholder="Sector" required="">
                                <input type="digits" name="nid" id="w3lPhone" placeholder="Name"
                                    required="">
                                <input type="digits" name="phone" id="w3lPhone" placeholder="Amount"
                                    required="">
                                <input type="text" name="address" id="w3lSubject" placeholder="Contact">

                                <input type="text" name="bloodgroup" id="w3lSubject" placeholder="Address">
                                                           
                            </div>
                            <textarea name="w3lMessage" id="w3lMessage" placeholder="Description"></textarea>
                            <br/>
                            <br/>
